            ...
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-6">
                    <div class="text-center my-5">
                        ...
                        <p class="lead text-white-50 mb-4">당신의 여행 목적은 무엇인가요? <br> 우리나라에서 즐길 수 있는 여행 목적을 골라보세요!</p>
                        <div class="d-grid gap-3 d-sm-flex justify-content-sm-center">
                            <a class="btn btn-primary btn-lg px-4 me-sm-3" href="#features">Let's GO!</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row gx-5">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3">
                        <button class="scroll-button btn btn-primary" onclick="scrollToFeature()">
                            <span class="material-symbols-outlined">sports_golf</span>
                        </button>

                    </div>
                    <h2 class="h4 fw-bolder" id="golf">골프</h2>
                    <p>골프를 위한 여행을 떠나고 싶으신 분!<br> 이 카테고리를 선택해 주세요</p>
                </div>
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p>스키를 위한 여행을 떠나고 싶으신 분!<br> 이 카테고리를 선택해 주세요<br>실내 스키장도 있어 계절 상관없이<br> 즐길 수 있는 지역도 있습니다.</p>
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p>관광유원을 위한 여행을 떠나고 싶으신 분!<br> 이 카테고리를 선택해주세요<br>원하시는 지역의 다양한 테마파크를 즐겨보세요!</p>
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <p>골프, 스키, 관광유원 이외에<br> 다른 레저를 즐기시고 싶으신 분!<br> 이 카테고리를 선택해주세요</p>
        ...
        <div class="col-lg-7">
            <div class="features-icons-item mx-auto mb-0 mb-lg-3">
                ...
                <form id="choicesForm" style="font-size: 20px; margin-top: 3px;">
                    <label><input type="checkbox" name="choices" value="미정"> 미정</label>
                    <label><input type="checkbox" name="choices" value="면세점"> 면세점</label>
                    <label><input type="checkbox" name="choices" value="레저용품 쇼핑"> 레저용품 쇼핑</label>
                    <label><input type="checkbox" name="choices" value="대형쇼핑몰"> 대형쇼핑몰</label>
                    <label><input type="checkbox" name="choices" value="문화서비스"> 문화서비스</label>
                </form>
            </div>
